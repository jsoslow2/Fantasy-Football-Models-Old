...
<!-- installation (only run if u haven't installed these packages yet) -->
<!-- ```{r} -->
...
# 
# getwd()
# setwd("/Users/jacksoslow/Downloads/fantasy football/data/past player data")
# 
...
passing <- read_csv("https://raw.githubusercontent.com/jsoslow2/Fantasy-Football-Models/master/data/past%20player%20data/passing.csv")
rushing <- read_csv("https://raw.githubusercontent.com/jsoslow2/Fantasy-Football-Models/master/data/past%20player%20data/rushing.csv")
receiving <- read_csv("https://raw.githubusercontent.com/jsoslow2/Fantasy-Football-Models/master/data/past%20player%20data/receiving.csv")
fantasyAll <- read_csv("https://raw.githubusercontent.com/jsoslow2/Fantasy-Football-Models/master/data/past%20player%20data/fantasyAll.csv")
```
...
#add a year so you attach last years stats to this years projections
...
for (i in 1:nrow(fantasy)) {
  ...
  nextYearsRow <- fantasy %>% filter(year == nextYear,
                          Player == name) %>% .[1,]
  
  
  nextYearsPoints <- ifelse(is.na(nextYearsRow$PPR), 0, nextYearsRow$PPR)
  row$actualPoints <- nextYearsPoints
  fantasy[i, ] <- row
}
```
...
pastProjections$closestName[pastProjections$position %in% c("ST", "K")] <- "noName"

pastProjections$sameName <- ifelse(pastProjections$Name == pastProjections$closestName, 1, 0)

#backwards Match o'clock
#find the most similar name in fantasy to ESPN names
for (i in 1:nrow(fantasy)) {
  row <- fantasy[i,]
  theYear <- row$year
...
fantasy$sameName <- ifelse(fantasy$closestName == fantasy$Player, 1, 0)

#now this is where it gets weird...
#lord please save my soul as I do this join
combined <- pastProjections %>% left_join(fantasy, by = c("closestName" = "Player",
                                                          "Name" = "closestName",
                                                  "year" = "year"))


#all rookies who were accidentally joined to rows
badJoins <- (combined$Name == "Ryan Matthews" & combined$year == 2010) |
  (combined$Name == "Jahvid Best" & combined$year == 2010) |
  (combined$Name == "Anthony Dixon" & combined$year == 2010) |
  (combined$Name == "Ryan Williams" & combined$year == 2012) |
  (combined$Name == "Mohamed Sanu" & combined$year == 2012) |
  (combined$Name == "Montee Ball" & combined$year == 2013) |
  (combined$Name == "Robert Woods" & combined$year == 2013) |
  (combined$Name == "Mike Evans" & combined$year == 2014) |
  (combined$Name == "Jeremy Hill" & combined$year == 2014) |
  (combined$Name == "Kelvin Benjamin" & combined$year == 2014) |
  (combined$Name == "Eric Ebron" & combined$year == 2014) |
  (combined$Name == "Tevin Coleman" & combined$year == 2015) |
  (combined$Name == "Dion Lewis" & combined$year == 2015) |
  (combined$Name == "Devin Smith" & combined$year == 2015) |
  (combined$Name == "Maxx Williams" & combined$year == 2015) |
  (combined$Name == "Will Fuller" & combined$year == 2016) |
  (combined$Name == "Kevin White" & combined$year == 2016) |
  (combined$Name == "Tyler Boyd" & combined$year == 2016) |
  (combined$Name == "Kareem Hunt" & combined$year == 2017) |
  (combined$Name == "Zay Jones" & combined$year == 2017) |
  (combined$Name == "Aaron Jones" & combined$year == 2017) |
  (combined$Name == "Wayne Gallman" & combined$year == 2017) |
  (combined$Name == "Calvin Ridley" & combined$year == 2018) |
  (combined$Name == "DJ Moore" & combined$year == 2018) |
  (combined$Name == "Dante Pettis" & combined$year == 2018) |
  (combined$Name == "Austin Carr" & combined$year == 2018) |
  (combined$Name == "Tre'Quan Smith" & combined$year == 2018) |
  (combined$Name == "Ian Thomas" & combined$year == 2018) |
  (combined$Name == "Ito Smith" & combined$year == 2018) |
  (combined$Name == "Josh Allen" & combined$year == 2018)

combined[badJoins, 17:(ncol(combined)-1)] <- NA
combined <- combined %>% select(-sameName.x, -sameName.y)
...
espnProjections$backwardsMatch[espnProjections$position %in% c("K", "ST")] <- ""
...
```{r}
draftedOverall <- c("Saquon Barkley",
                    "Christian McCaffrey",
                    "Alvin Kamara",
                    "Ezekiel Elliott",
                    "DeAndre Hopkins",
...
#Shiny app
```{r}
Names <- as.vector((available %>% arrange(ADP) %>% select(Name))[,2])
```
