...
espnProjections <- read_csv("2019 ESPN Fantasy Projections new.csv")
espnADP <- read_csv("2019 ESPN ADP.csv")

nflELO <- read_csv("nfl-elo/nfl_elo.csv")

projections2010 <- read_csv("2010 fantasy projections.csv")
#couldn't get 2011 projections
projections2012 <- read_csv("2012 fantasy projections.csv")
projections2013 <- read_csv("2013 fantasy projections.csv")
projections2014 <- read_csv("2014 fantasy projections.csv")
projections2015 <- read_csv("2015 Fantasy Projections.1.csv")
projections2016 <- read_csv("2016 Fantasy Projections.csv")
projections2017 <- read_csv("2017 projections new.csv")
projections2018 <- read_csv("2018 projections new new.csv")

totalQBR2019 <- read_csv("Total QBR - 2019 (1).csv")
totalQBR2018 <- read_csv("Total QBR - 2018.csv")
totalQBR2017 <- read_csv("Total QBR - 2017.csv")
totalQBR2016 <- read_csv("Total QBR - 2016 (1).csv")
totalQBR2015 <- read_csv("Total QBR - 2015.csv")
totalQBR2014 <- read_csv("Total QBR - 2014.csv")
totalQBR2013 <- read_csv("Total QBR - 2013.csv")
totalQBR2012 <- read_csv("Total QBR - 2012.csv")
totalQBR2010 <- read_csv("Total QBR - 2010.csv")

depthChart2019 <- read_csv("2019 espn depth charts.csv")
depthChart2018 <- read_csv("2018 depth charts.1.csv")
depthChart2017 <- read_csv("2017 depth charts.1.csv")
depthChart2016 <- read_csv("2016 depth charts.csv")
depthChart2015 <- read_csv("2015 depth charts.csv")
depthChart2014 <- read_csv("2014 depth charts.csv")
depthChart2012 <- read_csv("2012 depth charts.csv")
depthChart2010 <- read_csv("2010 depth charts.1.csv")
```
...
#start here if changing the league dimensions
